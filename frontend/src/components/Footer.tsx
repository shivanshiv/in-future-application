export default function Footer() {
	return (
		<footer className="relative mt-20 border-t border-white/20 bg-gradient-to-br from-neutral-950 to-neutral-900">
			...
			<div className="container-xl relative py-16">
				<div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
					...
					<div className="lg:col-span-2">
						<div className="flex items-center gap-3 text-white mb-6">
							...
							<span className="text-2xl font-bold tracking-tight">InFuture</span>
						</div>
						<p className="text-neutral-300 text-lg leading-relaxed max-w-md">
							Professional website development at affordable prices. Quality results through our innovative student-mentor collaboration model.
						</p>
						
						{/* Social links placeholder */}
						<div className="flex gap-4 mt-8">
							<div className="w-10 h-10 rounded-xl glass-effect flex items-center justify-center hover:bg-white/10 transition-colors duration-300 cursor-pointer">
					...
					<div>
						...
						<ul className="space-y-3 text-neutral-400">
							<li>
								<a href="#contact" className="hover:text-white transition-colors duration-300 flex items-center gap-2">
					...
					{/* Our Values */}
					<div>
						<h4 className="font-semibold text-white mb-4">Our Values</h4>
						<ul className="space-y-3 text-neutral-400">
				...
				<div className="border-t border-white/10 mt-16 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
					<p className="text-neutral-500 text-sm">
						© {new Date().getFullYear()} InFuture. All rights reserved.
					</p>
