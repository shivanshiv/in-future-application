				...
				<div className="max-w-4xl mx-auto text-center">
					<div className="animate-fade-in">
						...
						<p className="body-large max-w-3xl mx-auto mb-10 animate-slide-up" style={{ animationDelay: '0.2s' }}>
							We are InFuture — bridging the gap between education and industry through innovative Software 3.0 development. We deliver professional web solutions while providing valuable hands-on experience for students, with a special focus on supporting women engineers.
						</p>
